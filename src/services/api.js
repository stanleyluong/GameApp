 ...
 */
export const fetchGames = async (query = '', genre = '', score = '', platform = '', startDate = '', endDate = '', pageSize = 40) => {
  try {
...
export const fetchPlatforms = async () => {
  try {
    ...
    if (!response.ok) throw new Error(`Failed to fetch platforms: ${response.status}`);
